...
class Main:
    ...
    def laadGerecht(self, index):
        print("\n")
        print("--- Recept ---")
        print(self.gerechtenLijst[index])
    ...
    def laadAantalPersonen(self, index):
        gerecht = self.gerechtenLijst[index]

        try:
            aantalPersonen = int(input("Aantal mensen: "))
            gerecht.setAantalPersonen(aantalPersonen)

            self.laadStappen(index)
        except ValueError:
            print("Foutieve invoer")

            self.laadAantalPersonen(index)

    def laadStappen(self, index):
